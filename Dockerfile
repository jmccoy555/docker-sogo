...
RUN echo "untar SOPE sources" \
   ...
   && apt-get install -qy --no-install-recommends \
      ...
      wget \
      tzdata \
   && wget http://packages.inverse.ca/SOGo/nightly/3/ubuntu/pool/xenial/w/wbxml2/libwbxml2-0_0.11.6-1_amd64.deb  \
   && wget http://packages.inverse.ca/SOGo/nightly/3/ubuntu/pool/xenial/w/wbxml2/libwbxml2-dev_0.11.6-1_amd64.deb  \
